...
<head>
    ...
    <title>Tarea 6 - @yield('title')</title>
        ...
        <div class="row text-center p-4">
            ...
            <div id="col-md-10">
                <a href="https://www.facebook.com/youdevs">
                    <img src="{{asset('images/logo.png')}}" class="img-fluid" width="40px" alt="facebook youdevs">
                </a>
                <a href="https://www.instagram.com/youdevs">
                    <img src="{{asset('images/logo.png')}}" class="img-fluid" width="40px" alt="instagram youdevs">
                </a>
                <a href="https://www.youtube.com/c/YouDevsOficial">
                    <img src="{{asset('images/logo.png')}}" class="img-fluid" width="40px" alt="youtube youdevs">
                </a>
